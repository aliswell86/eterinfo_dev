  ...
  var callback_get_itemdb_list = function(data,textStatus,xhr) {
    ...
    if(row_cnt > 0) {
      ...
      $.each(data, function(i, obj) {
        if(i=='0' || i%6=='0'){
          if(utils.isMobile()) {
            html += "<div style=\"padding:4px;text-align:center;vertical-align:middle;\"><ins class=\"adsbygoogle\"     style=\"display:inline-block;width:300px;height:50px\"     data-ad-client=\"ca-pub-1407998984163880\"     data-ad-slot=\"6698737810\"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});</script><div>";
          }else{
